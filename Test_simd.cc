// FIXME still to test:
//
//  mac,add,sub,...,vone,vzero,vcomplex_i, =zero,
...
class funcMultRealPart {
public:
  funcMultRealPart() {};
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
    rr = real_mult(i1,i2);
    std::cout<<GridLogMessage<<"funcMultRealPart"<<'\n';
//    std::cout<< "--> i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " <<i2 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n "<< std::endl;}
  std::string name(void) const { return std::string("MultRealPart"); }
};
class funcMaddRealPart {
public:
  funcMaddRealPart() {};
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
    rr = real_madd(i1,i1,i2);
    std::cout<<GridLogMessage<<"funcMaddRealPart"<<'\n';
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " <<i2 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n "<< std::endl;}
  std::string name(void) const { return std::string("MaddRealPart"); }
};
...
public:
  ...
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
    vstream(rr,i1);
    std::cout<<GridLogMessage<<"funcVstream"<<'\n';
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n "<< std::endl;}
  std::string name(void) const { return std::string("Vstream"); }
};
class funcComplexVInit {
public:
  funcComplexVInit() {};
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
    std::cout<<GridLogMessage<<"funcComplexVInit"<<'\n';
    vone(rr);
    std::cout<<GridLogMessage<< "vone  rr "<< rr << "\n\n "<< std::endl;
    vzero(rr);
    std::cout<<GridLogMessage<< "vzero rr "<< rr << "\n\n "<< std::endl;
    vcomplex_i(rr);
    std::cout<<GridLogMessage<< "vcomplex_i rr "<< rr << "\n\n "<< std::endl;
    visign(rr);
    std::cout<<GridLogMessage<< "visign rr "<< rr << "\n\n "<< std::endl;
    vrsign(rr);
    std::cout<<GridLogMessage<< "visign rr "<< rr << "\n\n "<< std::endl;}
  std::string name(void) const { return std::string("ComplexVInit"); }
};
...
public:
  ...
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
    rr = i1+i2;
    std::cout<<GridLogMessage<<"funcPlus"<<'\n';
//    std::cout<< "--> i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " <<i2 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n "<< std::endl;}
...
public:
  ...
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
    rr = i1;
    rr += i2;
    std::cout<<GridLogMessage<<"funcUnaryPlus"<<'\n';
//    std::cout<< "--> i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " <<i2 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n "<< std::endl;}
  std::string name(void) const { return std::string("UnaryPlus"); }
};
class funcMinus {
public:
  funcMinus() {};
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
      rr = i1-i2;
    std::cout<<GridLogMessage<<"funcMinus"<<'\n';
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " <<i2 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
...
public:
  ...
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
      rr = i1;
    rr -= i2;
    std::cout<<GridLogMessage<<"funcUnaryMinus"<<'\n';
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " <<i2 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
  std::string name(void) const { return std::string("UnaryMinus"); }
};
class funcTimes {
public:
  funcTimes() {};
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
    rr = i1*i2;
    std::cout<<GridLogMessage<<"funcTimes"<<'\n';
//    std::cout<< "--> i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " <<i2 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n "<< std::endl;}
...
class funcUnaryTimes {
public:
  funcUnaryTimes() {};
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
      rr = i1;
    rr *= i2;
    std::cout<<GridLogMessage<<"funcUnaryTimes"<<'\n';
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " <<i2 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
  std::string name(void) const { return std::string("UnaryTimes"); }
};
class funcDivide {
public:
  funcDivide() {};
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
      rr = i1/i2;
    std::cout<<GridLogMessage<<"funcDivide"<<'\n';
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " <<i2 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
...
public:
  ...
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
      rr = conjugate(i1);
    std::cout<<GridLogMessage<<"funcConj"<<'\n';
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
...
public:
  ...
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
      rr = adj(i1);
    std::cout<<GridLogMessage<<"funcAdj"<<'\n';
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
...
public:
  ...
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
      rr = imag(i1);
    std::cout<<GridLogMessage<<"funcImag"<<'\n';
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
...
public:
  ...
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
      rr = real(i1);
    std::cout<<GridLogMessage<<"funcReal"<<'\n';
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
...
public:
  funcTimesI() {};
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
    std::cout<<GridLogMessage<<"funcTimesI"<<'\n';
    rr = timesI(i1);
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
...
public:
  funcTimesMinusI() {};
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
    std::cout<<GridLogMessage<<"funcTimesMinusI"<<'\n';
    rr = timesMinusI(i1);
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
...
public:
  funcInnerProduct() {};
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
    std::cout<<GridLogMessage<<"funcInnerProduct"<<'\n';
    rr = innerProduct(i1,i2);
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " <<i2 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
...
public:
  funcNorm2() {};
  template<class vec> void operator()(vec &rr,vec &i1,vec &i2) const {
    std::cout<<GridLogMessage<<"funcNorm2"<<'\n';
    rr = innerProduct(i1,i1);
    auto nrm = real(rr);
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    //std::cout<<GridLogMessage<< "i2 " <<i2 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;
    std::cout<<GridLogMessage<< "nrm "<< nrm << "\n\n " << std::endl;}
  std::string name(void) const { return std::string("Norm2"); }
};
...
public:
  funcReduce() {};
template<class reduce,class vec>    void vfunc(reduce &rr,vec &i1,vec &i2)   const {
    std::cout<<GridLogMessage<<"funcReduceVector"<<'\n';
    rr = Reduce(i1);
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
template<class reduce,class scal>   void sfunc(reduce &rr,scal &i1,scal &i2) const {
    std::cout<<GridLogMessage<<"funcReduceScalar"<<'\n';
    rr = i1;
    std::cout<<GridLogMessage<< "i1 " <<i1 << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;}
...
// Nils: workaround test function - displays only, no testing
// must be matched against e.g. GEN SIMD output
template<class scal, class vec,class functor >
void ShowMe(const functor &func)
{
  GridSerialRNG          sRNG;
...
*/
/*
  std::cout<<GridLogMessage<<"funcExtract"<<'\n';
  std::cout<<GridLogMessage<< "i1 " << v_input1 << std::endl;
  std::cout<<GridLogMessage<< "i2 " << v_input2 << std::endl;
  std::cout<<GridLogMessage<< "rr "<< v_result << "\n\n " << std::endl;
*/
/*
...
public:
  ...
  template<class vec>    void operator()(vec &rr,vec &i1,vec &i2) const {
    permute(rr,i1,n);
    std::cout<<GridLogMessage<<"funcPermuteVector"<<'\n';
    std::cout<<GridLogMessage<< "i1 " << i1 << std::endl;
  ...
  template<class scal>   void apply(std::vector<scal> &rr,std::vector<scal> &in)  const {
    ...
    std::cout<<GridLogMessage<<"funcPermuteScalar"<<'\n';
    std::cout<<GridLogMessage<< "in " << in << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;
  }
...
public:
  ...
  template<class vec>    void operator()(vec &r1,vec &r2,vec &i1,vec &i2) const {
    exchange(r1,r2,i1,i2,n);

    std::cout<<GridLogMessage<<"funcExchangeVector"<<'\n';
    std::cout<<GridLogMessage<< "i1 " << i1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " << i2 << std::endl;
    std::cout<<GridLogMessage<< "r1 " << r1 << std::endl;
    std::cout<<GridLogMessage<< "r2 "<< r2 << "\n\n " << std::endl;
  }
				    ...
				    std::vector<scal> &in2)  const
  {
    ...
    std::cout<<GridLogMessage<<"funcExchangeScalar"<<'\n';
    std::cout<<GridLogMessage<< "i1 " << in1 << std::endl;
    std::cout<<GridLogMessage<< "i2 " << in2 << std::endl;
    std::cout<<GridLogMessage<< "r1 " << r1 << std::endl;
    std::cout<<GridLogMessage<< "r2 "<< r2 << "\n\n " << std::endl;
  }
...
public:
  ...
  template<class vec>    void operator()(vec &rr,vec &i1,vec &i2) const {
    rr=rotate(i1,n);
    std::cout<<GridLogMessage<<"funcRotateVector"<<'\n';
    std::cout<<GridLogMessage<< "i1 " << i1 << std::endl;
    std::cout<<GridLogMessage<< "n  " << n << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;
}
  template<class scal>   void apply(std::vector<scal> &rr,std::vector<scal> &in)  const {
    ...
    std::cout<<GridLogMessage<<"funcRotateScalar"<<'\n';
    std::cout<<GridLogMessage<< "i1 " << in << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;
...
public:
  int n;
  func_tRotate(int _n) { n=_n;};
  template<class vec>    void operator()(vec &rr,vec &i1,vec &i2) const {
    rr=Grid::Optimization::Rotate::tRotate<n>(i1);
    std::cout<<GridLogMessage<<"func_tRotateVector"<<'\n';
    std::cout<<GridLogMessage<< "i1 " << i1 << std::endl;
    std::cout<<GridLogMessage<< "n  " << n << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;
}
  template<class scal>   void apply(std::vector<scal> &rr,std::vector<scal> &in)  const {
    ...
    std::cout<<GridLogMessage<<"func_tRotateScalar"<<'\n';
    std::cout<<GridLogMessage<< "i1 " << in << std::endl;
    std::cout<<GridLogMessage<< "rr "<< rr << "\n\n " << std::endl;

  }
  std::string name(void) const { return std::string("tRotate"); }
};
*/
...
//  merge<vec,scal>(v_result2,result1);
  ...
  merge<vec,scal>(v_result2,result2);
...
int main (int argc, char ** argv)
{
  ...
  ShowMe<RealF,vRealF>(funcVstream());
  Tester<RealF,vRealF>(funcPlus());
  Tester<RealF,vRealF>(funcUnaryPlus());
  Tester<RealF,vRealF>(funcMinus());
  Tester<RealF,vRealF>(funcUnaryMinus());
  Tester<RealF,vRealF>(funcTimes());
  Tester<RealF,vRealF>(funcUnaryTimes());
...
/*
  for(int r=0;r<2*vRealF::Nsimd();r++){
    PermTester<RealF,vRealF>(func_tRotate(r));
  }
*/
  ...
  ShowMe<RealD,vRealD>(funcVstream());
  Tester<RealD,vRealD>(funcPlus());
  Tester<RealD,vRealD>(funcUnaryPlus());
  Tester<RealD,vRealD>(funcMinus());
  Tester<RealD,vRealD>(funcUnaryMinus());
  Tester<RealD,vRealD>(funcTimes());
  Tester<RealD,vRealD>(funcUnaryTimes());
...
/*
  for(int r=0;r<2*vRealD::Nsimd();r++){
    PermTester<RealD,vRealD>(func_tRotate(r));
  }
*/
  ...
  ShowMe<ComplexF,vComplexF>(funcComplexVInit());
  ShowMe<ComplexF,vComplexF>(funcVstream());
  ShowMe<ComplexF,vComplexF>(funcMultRealPart());
  ShowMe<ComplexF,vComplexF>(funcMaddRealPart());
  Tester<ComplexF,vComplexF>(funcPlus());
  Tester<ComplexF,vComplexF>(funcTimesI());
  Tester<ComplexF,vComplexF>(funcTimesMinusI());
  Tester<ComplexF,vComplexF>(funcPlus());
  Tester<ComplexF,vComplexF>(funcUnaryPlus());
  Tester<ComplexF,vComplexF>(funcMinus());
  Tester<ComplexF,vComplexF>(funcUnaryMinus());
  Tester<ComplexF,vComplexF>(funcTimes());
  Tester<ComplexF,vComplexF>(funcUnaryTimes());
  ShowMe<ComplexF,vComplexF>(funcDivide());
 ...
 // Tester<ComplexF,vComplexF>(funcNorm2());
...
/*
  for(int r=0;r<2*vComplexF::Nsimd();r++){
    PermTester<ComplexF,vComplexF>(func_tRotate(r));
  }
*/
  std::cout<<GridLogMessage << "==================================="<<  std::endl;
  ...
  ShowMe<ComplexD,vComplexD>(funcComplexVInit());
  ShowMe<ComplexD,vComplexD>(funcVstream());
  ShowMe<ComplexD,vComplexD>(funcMultRealPart());
  ShowMe<ComplexD,vComplexD>(funcMaddRealPart());
  Tester<ComplexD,vComplexD>(funcTimesI());
  Tester<ComplexD,vComplexD>(funcTimesMinusI());
  Tester<ComplexD,vComplexD>(funcPlus());
  Tester<ComplexD,vComplexD>(funcUnaryPlus());
  Tester<ComplexD,vComplexD>(funcMinus());
  Tester<ComplexD,vComplexD>(funcUnaryMinus());
  Tester<ComplexD,vComplexD>(funcTimes());
  Tester<ComplexD,vComplexD>(funcUnaryTimes());
  ShowMe<ComplexD,vComplexD>(funcDivide());
 ...
 // Tester<ComplexD, vComplexD>(funcNorm2());
...
/*
  for(int r=0;r<2*vComplexD::Nsimd();r++){
    PermTester<ComplexD,vComplexD>(func_tRotate(r));
  }
*/
  std::cout<<GridLogMessage << "==================================="<<  std::endl;
